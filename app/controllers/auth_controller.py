...
from app.controllers_mappings.controller_user_mapper import ControllerUserMapper
...
async def register(user_register_request: UserRegisterRequestDto,
    ...
    user_register_service_dto = ControllerUserMapper.to_user_register_service_dto(user_register_request)
